...
type HeartbeatRequest struct {
	SessionID         string  `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	UsedMemoryPercent float64 `protobuf:"fixed64,2,opt,name=usedMemoryPercent,proto3" json:"usedMemoryPercent,omitempty"`
	UsedCpuPercent    float64 `protobuf:"fixed64,3,opt,name=usedCpuPercent,proto3" json:"usedCpuPercent,omitempty"`
}
...
func (m *HeartbeatRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UsedMemoryPercent != 0 {
		dAtA[i] = 0x11
		i++
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.UsedMemoryPercent))))
		i += 8
	}
	if m.UsedCpuPercent != 0 {
		dAtA[i] = 0x19
		i++
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.UsedCpuPercent))))
		i += 8
	}
	return i, nil
}
...
func (this *HeartbeatRequest) String() string {
	...
	s := strings.Join([]string{`&HeartbeatRequest{`,
		`SessionID:` + fmt.Sprintf("%v", this.SessionID) + `,`,
		`UsedMemoryPercent:` + fmt.Sprintf("%v", this.UsedMemoryPercent) + `,`,
		`UsedCpuPercent:` + fmt.Sprintf("%v", this.UsedCpuPercent) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *HeartbeatRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field UsedMemoryPercent", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			iNdEx += 8
			m.UsedMemoryPercent = float64(math.Float64frombits(v))
		case 3:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field UsedCpuPercent", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.UsedCpuPercent = float64(math.Float64frombits(v))
		default:
			iNdEx = preIndex
			skippy, err := skipDispatcher(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorDispatcher = []byte{
	...
	,
}
